...
export const translations = {
  ...
  cta: {
    ...
    form: {
      ...
      ageLabel: { uz: 'Yoshingiz', ru: 'Ваш возраст', en: 'Your age' },
      agePlaceholder: { uz: 'Masalan: 16', ru: 'Например: 16', en: 'E.g. 16' },
      schoolLabel: { uz: 'Maktab / Universitet', ru: 'Школа / Университет', en: 'School / University' },
      schoolPlaceholder: { uz: 'O\'qish joyingiz', ru: 'Место учебы', en: 'Place of study' },
      contactLabel: { uz: 'Telefon yoki Telegram Username', ru: 'Телефон или Telegram Username', en: 'Phone or Telegram Username' },
      contactPlaceholder: { uz: '+998... yoki @username', ru: '+998... или @username', en: '+998... or @username' },
